...
<html
  ...
  data-assets-path="{{ asset('cms/assets/') }}"
...
>
  ...
  <body>
          ...
          {{-- <ul class="menu-inner py-1">
            ...
            <!-- Layouts -->
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="{{ route('roles.all') }}" class="menu-link">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('proyek.all') }}" class="menu-link">
                    <div>Proyek</div>
                  </a>
                </li>
              </ul>
              <li class="menu-item">
                <a href="{{ route('task.all') }}" class="menu-link">
    ...
    <!-- Core JS -->
       ...
       <!-- Place any custom script overrides below this line -->
     </body>
   </html>
